...
const MOCK_NOTIFICATIONS = [
  {
    ...
    message: "ASSY-09 reported hydraulic leak.",
    time: "10m ago",
    type: "critical",
  },
  {
    id: 2,
    title: "Stock Alert",
    message: "Servo Motor 5kW below min level.",
    time: "1h ago",
    type: "warning",
  },
  {
    id: 3,
    title: "Shift Report",
    message: "Shift A production summary available.",
    time: "2h ago",
    type: "info",
  },
];
  ...
  return (
    <div className="h-screen bg-gray-50 dark:bg-gray-950 flex overflow-hidden text-gray-900 dark:text-gray-100 transition-colors duration-300 font-sans">
      ...
      >
        ...
        <div
          className={clsx(
            "h-20 flex items-center border-b border-gray-100 dark:border-gray-800 transition-all",
